...
// and there's no shared vocabulary to map it into. operador/valor/
// valorHasta (heredados de FiltroImporteQueryDto) filtran sobre
// Payment.amount.
export class ListPaymentsQueryDto extends FiltroImporteQueryDto {
  @IsOptional()
  @IsEnum(EstadoPago)
  status?: EstadoPago;
